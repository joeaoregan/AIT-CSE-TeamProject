...
- Bait Shop
    - [Exercise 1 Basic HTML Page](labs/exercise-1/index.md)
    - [Exercise 2.1 CSS](labs/exercise-2/1/index.md)
    - [Exercise 2.2 CSS – Box Model](labs/exercise-2/2/index.md)
    - [Exercise 2.3 CSS – Box Model – Floating elements](labs/exercise-2/3/index.md)
- Halloween Store
    - [Exercise 2.4](labs/exercise-2/4/index.md)
